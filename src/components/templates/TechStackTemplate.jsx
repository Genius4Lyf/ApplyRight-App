      ...
      <div className="cv-body p-12">
        <ReactMarkdown
          components={{
            ...
            h2: ({ node, ...props }) => (
              <h2
                className="text-lg font-bold text-slate-900 mb-4 mt-8 pb-1 border-b-2 border-slate-200 flex items-center font-mono uppercase tracking-wide"
                {...props}
              >
            ...
            ul: ({ node, ...props }) => (
              <ul
                className="list-none mb-4 space-y-1 text-sm leading-6 text-slate-600"
                {...props}
              />
            ),
            ...
            li: ({ node, ...props }) => (
              <li
                className="relative pl-5 before:content-['>'] before:absolute before:left-0 before:text-blue-500 before:font-mono before:font-bold before:text-xs before:top-[4px]"
                {...props}
              />
            ),
            ...
            code: ({ node, ...props }) => (
              <code
                className="bg-slate-100 text-slate-700 px-1 py-0.5 rounded text-xs font-mono border border-slate-200"
                {...props}
              />
            ),
            ...
            // HR
            hr: ({ node, ...props }) => <hr className="my-8 border-slate-100 dashed" {...props} />,
          }}
        >
          {bodyMarkdown}
        </ReactMarkdown>
