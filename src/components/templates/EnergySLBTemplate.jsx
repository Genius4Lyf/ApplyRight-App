      ...
      <div className="p-10 font-['Arimo',sans-serif]">
        <ReactMarkdown
          components={{
            ...
            h2: ({ node, ...props }) => (
              <h2
                className="text-xl font-bold text-[#0114DC] mt-8 mb-4 border-b-2 border-[#0114DC] pb-1 uppercase"
                {...props}
              />
            ),
            h3: ({ node, ...props }) => (
            ...
            h4: ({ node, ...props }) => (
              <h4
                className="text-sm font-bold text-black mb-2 uppercase tracking-wide"
                {...props}
              />
            ),
            p: ({ node, ...props }) => (
            ...
            ul: ({ node, ...props }) => (
              <ul
                className="list-disc pl-5 mb-4 text-[10.5pt] leading-6 text-[#2d3436] marker:text-black"
                {...props}
              />
            ),
