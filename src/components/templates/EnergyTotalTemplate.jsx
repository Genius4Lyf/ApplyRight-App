      ...
      <div className="p-12 font-['Titillium_Web',sans-serif]">
        <ReactMarkdown
          components={{
            ...
            h2: ({ node, ...props }) => (
              <h2
                className="text-xl font-bold text-[#034EA2] mt-8 mb-4 flex items-center gap-2"
                {...props}
              >
            ...
            ul: ({ node, ...props }) => (
              <ul
                className="list-disc pl-5 mb-4 text-[11pt] leading-7 text-slate-600 marker:text-black"
                {...props}
              />
            ),
