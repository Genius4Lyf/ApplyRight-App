      ...
      <div className="p-10 font-['Public_Sans',sans-serif]">
        <ReactMarkdown
          components={{
            ...
            h2: ({ node, ...props }) => (
              <h2
                className="text-lg font-bold text-[#23854B] mt-8 mb-4 uppercase tracking-wide border-b border-slate-200 pb-2"
                {...props}
              />
            ),
            h3: ({ node, ...props }) => (
            ...
            ul: ({ node, ...props }) => (
              <ul
                className="list-disc pl-5 mb-4 text-[10.5pt] leading-7 text-slate-600 marker:text-[#23854B]"
                {...props}
              />
            ),
