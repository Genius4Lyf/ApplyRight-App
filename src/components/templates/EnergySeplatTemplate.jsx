      ...
      <div className="p-10 font-['Lato',sans-serif]">
        <ReactMarkdown
          components={{
            ...
            h2: ({ node, ...props }) => (
              <h2
                className="text-xl font-bold text-[#2d3436] mt-8 mb-4 flex items-center gap-3"
                {...props}
              >
            ...
            h3: ({ node, ...props }) => (
              <h3
                className="text-base font-bold text-[#008751] mt-6 mb-1 uppercase tracking-wide"
                {...props}
              />
            ),
            h4: ({ node, ...props }) => (
            ...
            p: ({ node, ...props }) => (
              <p
                className="mb-4 text-justify text-[11pt] leading-7 text-slate-600 font-light"
                {...props}
              />
            ),
            ul: ({ node, ...props }) => (
              <ul
                className="list-disc pl-5 mb-4 text-[11pt] leading-7 text-slate-600 font-light marker:text-[#008751]"
                {...props}
              />
            ),
