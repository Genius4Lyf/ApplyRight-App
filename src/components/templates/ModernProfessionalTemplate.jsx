...
const ModernProfessionalTemplate = ({ markdown, userProfile }) => {
  ...
  return (
    <div
      className="bg-white mx-auto text-[#333333] text-[10.5pt]"
      style={{
      ...
      <div className="cv-body">
        <ReactMarkdown
          components={{
            ...
            li: ({ node, ...props }) => <li className="pl-1 marker:text-[#888888]" {...props} />,
            ...
            a: ({ node, ...props }) => (
              <a
                className="text-[#333333] underline decoration-[#cccccc] decoration-1 underline-offset-2"
                {...props}
              />
            ),
          }}
