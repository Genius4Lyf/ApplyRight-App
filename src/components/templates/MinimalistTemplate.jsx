      ...
      <div className="cv-body space-y-4">
        <ReactMarkdown
          components={{
            ...
            h2: ({ node, ...props }) => (
              <h2
                className="text-xs font-bold text-slate-900 uppercase tracking-[0.2em] mt-10 mb-6"
                {...props}
              />
            ),
            ...
            ul: ({ node, ...props }) => (
              <ul
                className="list-disc pl-5 mb-6 space-y-2 text-sm font-light leading-7 text-slate-600"
                {...props}
              />
            ),
            ...
            a: ({ node, ...props }) => (
              <a
                className="text-slate-800 border-b border-slate-300 hover:border-slate-800 pb-[1px] transition-colors"
                {...props}
              />
            ),
