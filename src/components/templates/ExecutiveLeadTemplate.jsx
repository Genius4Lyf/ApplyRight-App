          ...
          <div className="p-10 cv-body font-['Lato',sans-serif]">
            <ReactMarkdown
              components={{
                ...
                h2: ({ node, ...props }) => (
                  <h2
                    className="text-md font-serif font-bold text-slate-900 uppercase tracking-widest mb-6 mt-10 border-b-2 border-slate-800 pb-2"
                    {...props}
                  />
                ),
                ...
                h4: ({ node, ...props }) => (
                  <h4
                    className="text-sm font-bold text-slate-500 mb-3 uppercase tracking-wide"
                    {...props}
                  />
                ),
                ...
                ul: ({ node, ...props }) => (
                  <ul
                    className="list-square mb-6 space-y-2 text-sm leading-7 text-slate-700 ml-5"
                    {...props}
                  />
                ),
                ...
                a: ({ node, ...props }) => (
                  <a
                    className="text-slate-900 underline decoration-slate-400 decoration-1 underline-offset-2"
                    {...props}
                  />
                ),
