...
const RoleBriefCard = ({ brief, jobTitle, onConfirm, onEdit }) => {
  ...
  return (
    <AriaCard cardKey="brief">
      <div className="w-full min-w-0 rounded-2xl rounded-tl-md border border-slate-200 dark:border-slate-800 border-l-2 border-l-slate-900 dark:border-l-white bg-white dark:bg-slate-900 p-4 sm:p-5">
