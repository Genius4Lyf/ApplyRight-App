      ...
      <div className="w-full max-w-2xl p-8 relative">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {/* Category Label */}
            <span
              className={`text-xs font-bold tracking-wider uppercase px-3 py-1 rounded-full mb-4 ${LOADING_STEPS[currentStep].bg} ${LOADING_STEPS[currentStep].color} bg-opacity-50`}
            >
