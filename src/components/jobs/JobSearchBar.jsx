      ...
      <div className="flex flex-col sm:flex-row gap-2">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-white border border-slate-200 rounded-lg text-[16px] sm:text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
          />
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3 p-3 bg-slate-50 rounded-lg border border-slate-100">
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="text-[16px] sm:text-sm border border-slate-200 rounded-md px-2 py-2.5 bg-white focus:outline-none focus:ring-1 focus:ring-indigo-500"
            >
              {COUNTRIES.map((c) => (
