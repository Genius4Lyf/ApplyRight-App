  ...
  const guideContent = {
    ...
    heading: {
      ...
      donts: [
        ...
        'Include photos (unless in specific regions)',
        'Use fancy fonts for your name',
      ],
    ...
    summary: {
      ...
      dos: [
        ...
        'Mention years of experience + top skills',
        'Tailor it to the Target Job',
      ],
      donts: [
        "Use generic cliches ('Hard worker')",
        'Write a full cover letter here',
        'Talk about what you want, focus on what you offer',
      ],
    ...
    history: {
      ...
      donts: [
        "List just duties ('Responsible for X')",
        'Leave gaps in employment unexplained',
        'Use tables or columns which confuse parsers',
      ],
    ...
    projects: {
      ...
      dos: [
        'Link to live demos or repos',
        "Explain the 'Why' and 'How'",
        'Mention technologies used',
      ],
      donts: [
        'List trivial school assignments (unless entry level)',
        'Forget to mention your specific contribution',
      ],
    ...
    education: {
      ...
      dos: [
        'List degree, major, and school',
        'Include graduation year',
        'Mention honors if recent grad',
      ],
    ...
    skills: {
      ...
      donts: [
        "List generic soft skills ('Good communicator') without context",
        'Lie about proficiency',
      ],
