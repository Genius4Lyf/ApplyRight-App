...
const TOUR_STEPS = [
  {
    ...
    description:
      "Your personal AI career assistant. Let's take a quick tour of your new command center.",
    icon: Sparkles,
  ...
  },
  {
    ...
    description:
      'Start with 20 free A.I credits. Upload a CV for 15 A.I credits or run a full analysis for 30 A.I credits. Earn more by watching short ads.',
    icon: Zap,
  ...
  },
  {
    ...
    description:
      'Upload your CV and a job description to get an instant AI compatibility score and actionable advice.',
    icon: Upload,
  ...
  },
  {
    ...
    description:
      'Create ATS-friendly resumes from scratch or edit existing ones with our intelligent builder.',
    icon: PenTool,
    color: 'text-blue-600',
    bg: 'bg-blue-100',
  },
  {
    ...
    description:
      'We rewrite your bullet points to match the job requirements perfectly. Never send a generic CV again.',
    icon: BarChart2,
    color: 'text-rose-600',
    bg: 'bg-rose-100',
  },
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm animate-in fade-in duration-300">
      <motion.div
        ...
        className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl w-full max-w-xl overflow-hidden relative"
      >
        {/* Close Button */}
        <button
          onClick={handleClose}
