...
export const VoiceStyleSelector = ({
  ...
  <div
    className={
      borderless
        ? `relative z-10 space-y-3 ${className}`
        : `relative z-10 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-4 space-y-3 ${className}`
    }
  >
