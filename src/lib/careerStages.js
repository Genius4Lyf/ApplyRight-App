...
export const CAREER_STAGES = [
  {
    ...
    labelKey: 'ariaStudio.chat.careerStage.options.grad',
  },
  {
    k: 'experienced',
    label: 'Experienced',
    labelKey: 'ariaStudio.chat.careerStage.options.experienced',
  },
  {
    k: 'changer',
    label: 'Changing careers',
    labelKey: 'ariaStudio.chat.careerStage.options.changer',
  },
];
