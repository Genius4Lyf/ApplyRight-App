...
export const CREDIT_COSTS = {
  ...
  // on the Basic (light) model regardless of the user's gen-model pick (the backend
  ...
  // server-pinned to the Basic (light) model, so this light cost is what's billed.
  PROJECT_IDEAS: 1,
