...
const DimensionRow = ({ label, valueA, valueB, weight }) => {
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-12 items-center gap-2 py-2.5 border-b border-slate-100 dark:border-slate-800 last:border-b-0 text-sm">
        ...
        {!loading && !error && appA && appB && (
          <>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-5 mt-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-12 gap-2 pb-2 border-b border-slate-100 dark:border-slate-800 text-[10px] uppercase tracking-wider font-bold text-slate-400 dark:text-slate-500">
