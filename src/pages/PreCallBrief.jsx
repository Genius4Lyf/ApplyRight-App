...
const Section = ({ icon, title, hint, children }) => (
  <section className="break-inside-avoid">
    <div className="flex items-center gap-2 mb-2">
      {React.createElement(icon, { className: 'w-4 h-4 text-indigo-600 shrink-0' })}
  ...
  return (
    <div className="min-h-screen bg-slate-100">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-5 sm:p-8 space-y-7">
          {/* Title block */}
          <div className="flex items-start justify-between gap-4 pb-4 border-b border-slate-100">
            <div className="min-w-0">
              ...
              <h1 className="text-xl sm:text-2xl font-bold text-slate-900 mt-0.5 leading-tight">
                {title}
              </h1>
          ...
          {isEmpty ? (
            <div className="text-center py-10">
              <p className="text-sm font-semibold text-slate-900 mb-1">Nothing to brief yet</p>
            ...
            <>
              ...
              {questions.length > 0 && (
                <Section icon={MessageSquare} title="Questions to review" hint="weakest first">
                  <div className="space-y-3">
                    {questions.map((q) => (
                      <div key={q._i} className="border-l-2 border-indigo-200 pl-3">
                ...
                <Section icon={StickyNote} title="Don't forget">
                  <div className="space-y-2">
                    {notes.map((n, i) => (
                      <div
                        key={n.id || i}
                        className="bg-amber-50/60 border border-amber-200 rounded-lg p-3"
                      >
