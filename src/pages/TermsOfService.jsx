          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 md:p-12 space-y-10">
            <section>
              ...
              <p className="text-slate-600 leading-relaxed">
                ...
                whether personally or on behalf of an entity ("you") and ApplyRight ("we," "us" or
                "our"), concerning your access to and use of the ApplyRight website as well as any
            ...
            <section>
              ...
              <p className="text-slate-600 leading-relaxed">
                ...
                regarding use of the Site, please contact us at support@applyright.com.
              </p>
            </section>
          </div>
        </motion.div>
