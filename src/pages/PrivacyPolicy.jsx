          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 md:p-12 space-y-10">
            <section>
              ...
              <p className="text-slate-600 leading-relaxed">
                Welcome to ApplyRight ("we," "our," or "us"). We are committed to protecting your
                personal information and your right to privacy. If you have any questions or
                concerns about this privacy notice, or our practices with regards to your personal
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-slate-600">
                <li>
                  Personal Information Provided by You: Names, email addresses, passwords, and other
                  similar information.
                </li>
                <li>
                  Resume Data: Information contained in the CVs/Resumes you upload for analysis.
                </li>
                <li>
            ...
            <section>
              ...
              <div className="bg-slate-50 p-6 rounded-xl border border-slate-100">
                ...
                <p className="text-slate-600 text-sm">
                  ...
                  use of the DoubleClick cookie enables it and its partners to serve ads to our
                  users based on their visit to our site and/or other sites on the Internet. You may
                  opt out of the use of the DoubleClick cookie for interest-based advertising by
                  visiting user's{' '}
                  <a
