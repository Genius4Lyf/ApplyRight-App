    ...
    try {
      if (isLogin) {
        ...
        if (
          ...
          toast.error(
            'Password must be at least 12 characters long, include uppercase & lowercase letters, a number, and a special character.'
          );
          return;
        }
              ...
              {!isLogin && (
                <div className="mt-2 text-xs">
                  ...
                  <p className="text-gray-500">
                    Must be at least 12 characters long, include uppercase & lowercase letters, a
