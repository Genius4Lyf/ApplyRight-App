        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 leading-relaxed mt-1">
                Enter the <strong>exact Job Title and Company Name</strong>. Our AI uses this to
                tailor suggestions to your specific industry.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 leading-relaxed mt-1">
                Add <strong>at least 2 bullet points</strong> about what your job role is about in
                the Description box. Our AI will help you expand and rewrite them into ATS-ready
                bullet points!
              </p>
            </div>
          </div>
