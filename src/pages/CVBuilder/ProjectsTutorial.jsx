...
import { FlaskConical, ClipboardPaste, X, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-end sm:items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      <motion.div
        ...
        className="bg-white dark:bg-slate-900 w-full sm:max-w-3xl rounded-xl shadow-2xl relative overflow-hidden max-h-[90dvh] overflow-y-auto border border-slate-100 dark:border-slate-800"
      >
        <button
          type="button"
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 items-stretch">
            ...
            <div className="md:col-span-7 flex flex-col justify-between">
              <div>
                ...
                <div className="w-11 h-11 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 flex items-center justify-center mb-4 p-2">
                ...
                <h2 className="font-heading text-xl font-bold text-slate-900 dark:text-slate-100 mb-2 leading-tight">
                ...
                <div className="space-y-5">
                  <div className="flex gap-3">
                    <div className="shrink-0 w-9 h-9 rounded-lg bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center text-slate-500 dark:text-slate-400">
            ...
            <div className="md:col-span-5 flex flex-col justify-between bg-slate-50 dark:bg-slate-950/50 rounded-xl p-5 border border-slate-100 dark:border-slate-800/80">
              ...
              <div className="mt-6 pt-4 border-t border-slate-200/50 dark:border-slate-800/50 flex justify-end">
                <button
                  type="button"
                  onClick={handleDismiss}
                  className="btn-primary w-full px-5 py-2.5 flex items-center justify-center gap-2 text-sm"
                >
                  Got it
