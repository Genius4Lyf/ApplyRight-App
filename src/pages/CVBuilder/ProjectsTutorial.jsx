        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 leading-relaxed mt-1">
                Enter a clear <strong>Project Name</strong> and what you achieved (e.g. "Marketing
                Campaign", "Community Initiative"). Our AI uses this to highlight your impact.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 leading-relaxed mt-1">
                Paste a rough list of tasks, results, or a description. Our AI will optimize it into{' '}
