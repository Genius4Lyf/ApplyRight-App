            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 mt-1 leading-relaxed">
                  ...
                  {skillsWithEvidenceCount === 1 ? '' : 's'} come with evidence from your work,
                  education, and projects, plus talking points you can rehearse. These are exactly
                  what interviewers tend to drill into — save them so you can review before the
                  call.
                </p>
