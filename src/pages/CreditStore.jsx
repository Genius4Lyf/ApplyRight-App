...
const CreditStore = () => {
  ...
  return (
    ...
    >
      <div className="min-h-full py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className="max-w-5xl mx-auto space-y-12 relative z-10">
          {/* Header */}
          {/* No close button above this any more: the page sits inside the account shell,
              whose sidebar is the way out, so an X here closed nothing — it only stepped
              back one history entry. The pt-14 that cleared it on a phone went with it. */}
          ...
          {/* ══ ZONE 2b — Aria call minutes ══════════════════════════════
              The spoken CV build. A SEPARATE balance from the interview minutes below,
              ...
              ABOVE the interview minutes, and deliberately: talking to Aria has NO free
              taste, so this is the only one of the three that a user can arrive here
              literally unable to use. Everyone sent here from the Studio — every
              out-of-minutes card, every "get credits" — is coming for this row, and making
              them scroll past a product they did not ask about to reach it is a tax on the
              one journey that ends in a purchase.

              Deliberately NOT behind the isPaid gate the interview top-ups sit behind. The
              buyer is precisely the free student trying to get their first role out of
              their head — telling them to subscribe first would close the door at the
              moment it opened. */}
          <section>
            <SectionHeading
          ...
          {/* ══ ZONE 2c — Top up interview minutes ═══════════════════════ */}
          <section>
            <SectionHeading
