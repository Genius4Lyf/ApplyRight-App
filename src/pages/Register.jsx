...
const Register = () => {
  ...
  const onSubmit = async (e) => {
    ...
    if (!emailRegex.test(email)) {
      setError(
        'Please enter a valid email address with a recognized domain (e.g., @gmail.com, @outlook.com)'
      );
      return;
    }
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                {password && passwordStrength.label && (
                  <div
                    className={`mt-2 px-3 py-2 rounded-lg border text-xs font-medium ${passwordStrength.color}`}
                  >
            ...
            <div className="flex items-start">
              <div className="flex items-center h-5">
                <input
                  ...
                  required
                  disabled={isLoading}
                  className="w-4 h-4 border border-slate-300 rounded bg-slate-50 focus:ring-3 focus:ring-primary/20 accent-primary disabled:opacity-50"
                />
              </div>
