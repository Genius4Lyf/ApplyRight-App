  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-slate-200/50 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 opacity-70"></div>
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-slate-100/60 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2 opacity-70"></div>
        <AppParticles />
      </div>
      ...
      <div className="relative z-10 bg-white/80 backdrop-blur-md rounded-2xl shadow-xl max-w-lg w-full p-8 text-center animate-in fade-in zoom-in duration-300 border border-white/50">
        ...
        <div className="space-y-4">
          ...
          <p className="text-slate-500 text-sm">Thank you for your patience.</p>
        </div>
      </div>
    </div>
  );
