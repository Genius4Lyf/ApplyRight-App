...
const ApplicationReview = () => {
  ...
  const ParticleBackground = React.memo(({ init, id }) => {
    ...
    return <Particles id={id} className="absolute inset-0" options={particlesOptions} />;
  });
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-slate-900 mb-8 leading-tight tracking-tight">
              ...
              <br />
              <span className="text-3xl md:text-5xl text-slate-500 font-medium block mt-2">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                99% of Fortune 500 companies use Applicant Tracking Systems. These bots scan your
                resume for specific keywords found in the job description.
              </p>
              <p className="text-lg text-slate-600 leading-relaxed border-l-4 border-red-500 pl-4 bg-red-50 p-4 rounded-r-lg">
                ...
                If you call yourself a "Customer Service Pro" but the job asks for a "Client Success
                Specialist", you get auto-rejected. Even if you're perfect for the job.
              </p>
            </motion.div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="w-[300px] h-[300px] rounded-full flex items-center justify-center relative bg-white shadow-2xl">
                ...
                <svg className="absolute inset-0 w-full h-full -rotate-90 pointer-events-none overflow-visible">
                  {/* Background Track */}
                  <circle cx="150" cy="150" r="138" fill="none" stroke="#f1f5f9" strokeWidth="12" />
                  {/* Animated Progress */}
                  <motion.circle
                    cx="150"
                    cy="150"
            ...
            >
              ...
              <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                If you pass the bot, you reach the recruiter. But they are busy. Studies show they
                spend an average of <strong>6 seconds</strong> on a resume before deciding "Yes" or
                "No".
              </p>
              <p className="text-lg text-slate-600 leading-relaxed">
                Cluttered layouts, walls of text, or confusing structures get skipped. You need
                clean, professional formatting that highlights your impact instantly.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-24 bg-indigo-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center mb-16">
          ...
          <h3 className="text-4xl md:text-6xl font-bold mb-6 text-white">
            How ApplyRight Bridges the Gap
          </h3>
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-8 relative z-10">
          ...
          >
            ...
            <p className="text-indigo-50 leading-relaxed mb-6">
              Our AI analyzes the job description, isolates the "must-have" keywords, and seamlessly
              weaves them into your skills and experience sections. Your Match Score goes from 42%
              to 95%.
            </p>
          ...
          >
            ...
            <p className="text-indigo-50 leading-relaxed mb-6">
              We output your optimized content into visually stunning, recruiter-approved templates.
              Clean lines, perfect hierarchy, and scannable bullet points that pass the 6-second
              test.
            </p>
